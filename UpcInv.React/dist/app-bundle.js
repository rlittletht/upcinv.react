...
Object.defineProperty(exports, "__esModule", { value: true });
const WebApiInterop_1 = __webpack_require__(/*! ./WebApiInterop */ "./Service/WebApiInterop.ts");
class UpcApi {
    constructor(sApiRoot) {
        this.m_apiInterop = new WebApiInterop_1.WebApiInterop(sApiRoot);
    }
    GetBookScanInfo(ScanCode) {
        return __awaiter(this, void 0, void 0, function* () {
            var scanInfo;
            scanInfo = yield this.m_apiInterop.Fetch("api/book/GetBookScanInfo", [{ "ScanCode": ScanCode }]);
            return scanInfo;
        });
    }
}
exports.UpcApi = UpcApi;
...
(function (UpcInvModel) {
    class UpcInvMain {
        ...
        fillMockData(setResults) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                var item;
                item = new UpcItem_1.UpcItemModel.GenericItem(this.m_upcApi);
    ...
    UpcInvModel.UpcInvMain = UpcInvMain;
})(UpcInvModel = exports.UpcInvModel || (exports.UpcInvModel = {}));
...
(function (UpcItemModel) {
    class GenericItem {
        ...
        Lookup(id) {
            return __awaiter(this, void 0, void 0, function* () {
                let scanInfo = yield this.m_upcApi.GetBookScanInfo(id);
    ...
    UpcItemModel.GenericItem = GenericItem;
})(UpcItemModel = exports.UpcItemModel || (exports.UpcItemModel = {}));
